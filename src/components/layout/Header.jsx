...
const Header = ({ onNavigate, onSearch, onOpenLogin }) => {
  ...
  const handleLocationClick = () => {
    // No mobile, abre modal. No desktop, abre dropdown
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              <div className="relative location-menu-container">
                <button
                  ...
                  className="flex items-center space-x-1 md:space-x-2 px-2 md:px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors text-xs md:text-sm font-medium text-gray-700"
                >
                  ...
                  <div className="hidden md:block absolute left-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50 max-h-96 overflow-y-auto">
                    ...
                    {estados.map((estado) => (
                      <div key={estado.code} className="px-2 py-1">
                        <div className="px-2 py-2 text-sm font-medium text-gray-900 bg-gray-50 rounded">
              ...
              {isAuthenticated ? (
                ...
                <button
                  ...
                  className="bg-teal-600 hover:bg-teal-700 text-white font-medium px-3 md:px-4 py-2 rounded-lg transition-colors flex items-center space-x-2 text-sm"
                >
